      ...
      <div className="container mx-auto px-4 lg:px-8 py-3 sm:py-4">
        <div className="flex items-center gap-3 sm:gap-5">
          ...
          <div className="flex items-center gap-2 sm:gap-3 ml-auto shrink-0">
            {user ? (
              <>
                <Link to="/dashboard" className="hidden sm:inline text-sm font-bold text-slate-700 hover:text-orange-600 no-underline transition-colors px-3 py-2 rounded-xl hover:bg-orange-50">
                  Account
                </Link>
                <button type="button" className="hidden sm:inline text-sm font-semibold text-slate-500 hover:text-slate-800 transition-colors px-3 py-2 rounded-xl hover:bg-slate-100" onClick={logout}>
                  Logout
                </button>
              </>
            ) : (
              <Link to="/login" className="hidden sm:flex items-center gap-2 text-sm font-bold text-slate-800 hover:text-orange-600 no-underline px-3 py-2 rounded-xl hover:bg-orange-50 transition-colors">
